...
/** @deprecated Use an observer instead of a complete callback */
export function tap<T, P extends T>(next: (value: P) => void, error: null | undefined, complete: () => void): MonoTypeOperatorFunction<T>;
export function tap<T, P extends T>(next?: (x: P) => void, error?: (e: any) => void, complete?: () => void): MonoTypeOperatorFunction<T>;
export function tap<T, P extends T>(observer: PartialObserver<P>): MonoTypeOperatorFunction<T>;
