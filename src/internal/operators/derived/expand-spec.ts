...
import { EMPTY, Observable, of, Observer } from 'rxjs';
...
describe('expand operator', () => {
  ...
  //     const result = e1.pipe(expand(x => x === 8 ? EMPTY : e2.map(c => c * x), Number.POSITIVE_INFINITY, testScheduler));
