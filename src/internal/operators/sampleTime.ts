 ...
 * @owner Observable
 */
export function sampleTime<T>(period: number, scheduler: ISchedulerLike = async): MonoTypeOperatorFunction<T> {
...
function dispatchNotification<T>(this: ISchedulerAction<any>, state: any) {
