...
import 'rxjs-compat/add/operator/smoosh';
import 'rxjs-compat/add/operator/smooshAll';
import 'rxjs-compat/add/operator/smooshMap';
import 'rxjs-compat/add/operator/smooshMapTo';
