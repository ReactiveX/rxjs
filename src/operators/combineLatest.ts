...
export function combineLatest<T, T2, T3, T4, T5, T6>(
    ...
    fourth: ObservableOrIterable<T4>,
    fifth: ObservableOrIterable<T5>,
    sixth: ObservableOrIterable<T6>): Observable<[T, T2, T3, T4, T5, T6]>;
export function combineLatest<T, T2, T3, T4, T5, T6, TResult>(
    second: ObservableOrIterable<T2>,
    third: ObservableOrIterable<T3>,
    fourth: ObservableOrIterable<T4>,
    fifth: ObservableOrIterable<T5>,
    sixth: ObservableOrIterable<T6>,
...
export function combineLatest<T, T2, T3, T4, T5, T6, T7>(
    ...
    fifth: ObservableOrIterable<T5>,
    sixth: ObservableOrIterable<T6>,
    eventh: ObservableOrIterable<T7>): Observable<[T, T2, T3, T4, T5, T6, T7]>;
export function combineLatest<T, T2, T3, T4, T5, T6, T7, TResult>(
    ...
    fifth: ObservableOrIterable<T5>,
    sixth: ObservableOrIterable<T6>,
    eventh: ObservableOrIterable<T7>,
...
export function combineLatest<T, T2, T3, T4, T5, T6, T7, T8>(
    ...
    fifth: ObservableOrIterable<T5>,
    sixth: ObservableOrIterable<T6>,
    seventh: ObservableOrIterable<T7>,
    eighth: ObservableOrIterable<T8>): Observable<[T, T2, T3, T4, T5, T6, T7, T8]>;
export function combineLatest<T, T2, T3, T4, T5, T6, T7, T8, TResult>(
    ...
    sixth: ObservableOrIterable<T6>,
    seventh: ObservableOrIterable<T7>,
    eighth: ObservableOrIterable<T8>,
...
export function combineLatest<T, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...
    seventh: ObservableOrIterable<T7>,
    eighth: ObservableOrIterable<T8>,
    ninth: ObservableOrIterable<T9>): Observable<[T, T2, T3, T4, T5, T6, T7, T8, T9]>;
