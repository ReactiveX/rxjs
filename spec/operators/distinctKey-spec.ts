...
describe('Observable.prototype.distinctKey', () => {
  asDiagram('distinctKey(\'k\')')('should distinguish between values', () => {
    ...
    const result = (<any>e1).distinctKey('k');
  ...
  it('should not completes if source never completes', () => {
    ...
    expectObservable((<any>e1).distinctKey('val')).toBe(expected);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  });
  ...
  it('should allow unsubscribing early and explicitly', () => {
    ...
    const result = (<any>e1).distinctKey('val');
  ...
  it('should emit once if comparer returns true always regardless of source emits', () => {
    ...
    expectObservable((<any>e1).distinctKey('val', () => true)).toBe(expected, values);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  });
  ...
  it('should emit all if comparer returns false always regardless of source emits', () => {
    ...
    expectObservable((<any>e1).distinctKey('val', () => false)).toBe(expected, values);
    expectSubscriptions(e1.subscriptions).toBe(e1subs);
  });
