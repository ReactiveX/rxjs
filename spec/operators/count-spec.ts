...
describe('count', () => {
  ...
  it('should count a range() source observable', (done: Mocha.Done) => {
    range(1, 10)
      .pipe(count())
      .subscribe(
        (value: number) => {
  ...
  it('should count a range().skip(1) source observable', (done: Mocha.Done) => {
    range(1, 10)
      .pipe(skip(1), count())
      .subscribe(
        (value: number) => {
  ...
  it('should count a range().take(1) source observable', (done: Mocha.Done) => {
    range(1, 10)
      .pipe(take(1), count())
      .subscribe(
        (value: number) => {
