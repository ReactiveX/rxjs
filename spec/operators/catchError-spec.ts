...
describe('catchError operator', () => {
  ...
  it('should pass the error as the first argument', (done: Mocha.Done) => {
    throwError('bad').pipe(
      catchError((err: any) => {
  ...
  it('should accept selector returns any ObservableInput', (done: Mocha.Done) => {
  ...
  context('fromPromise', () => {
    ...
    it('should chain a throw from a promise using Observable.throw', (done: Mocha.Done) => {
  ...
  it('Properly handle async handled result if source is synchronous', (done: Mocha.Done) => {
