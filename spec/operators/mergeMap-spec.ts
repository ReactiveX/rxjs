...
describe('mergeMap', () => {
  ...
  it('should support nested merges', (done: Mocha.Done) => {
  ...
  it('should support nested merges with promises', (done: Mocha.Done) => {
    // Added as a failing test when investigating:
    // https://github.com/ReactiveX/rxjs/issues/4071
  ...
  it('should support wrapped sources', (done: Mocha.Done) => {
    // Added as a failing test when investigating:
