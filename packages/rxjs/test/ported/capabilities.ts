...
export async function loadCapabilities(): Promise<{
  ...
  const [
    ...
    import('../../src/pipe.js'),
    import('../../src/pluck.js'),
    import('../../src/publish-behavior.js'),
    import('../../src/publish-last.js'),
    import('../../src/publish-replay.js'),
  ...
  const capabilities = {
    operators: {
      ...
      publishBehavior: publishBehaviorModule.publishBehavior,
      publishLast: publishLastModule.publishLast,
      publishReplay: publishReplayModule.publishReplay,
