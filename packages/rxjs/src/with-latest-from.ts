...
declare global {
  interface Observable<T> {
    [withLatestFrom]: <Sources extends readonly ObservableValue<any>[]>(
      sources: Sources
    ) => Observable<[T, ...ObservedValuesOf<Sources>]>;
  }
}

Observable.prototype[withLatestFrom] = function withLatestFromImpl<
  T,
...
>(
  ...
  return this[combine]([
    { source: this, causesEmit: true },
    ...sources.map((source) => ({ source, causesEmit: false })),
  ]) as any;
};
