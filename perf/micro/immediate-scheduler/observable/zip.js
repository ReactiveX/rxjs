...
module.exports = function zip(suite) {
    ...
    var oldZipWithImmediateScheduler = RxOld.Observable.zip(RxOld.Observable.range(0, 25, RxOld.Scheduler.immediate), RxOld.Observable.range(0, 25, RxOld.Scheduler.immediate), add);
