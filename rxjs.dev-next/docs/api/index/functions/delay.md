[API](../../index.md) / [index](../index.md) / delay
...
Defined in: [internal/operators/delay.ts:62](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/delay.ts#L62)
