[API](../../index.md) / [index](../index.md) / defaultIfEmpty
...
Defined in: [internal/operators/defaultIfEmpty.ts:40](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/defaultIfEmpty.ts#L40)
