[API](../../index.md) / [index](../index.md) / isEmpty
...
Defined in: [internal/operators/isEmpty.ts:66](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/isEmpty.ts#L66)
