[API](../../index.md) / [index](../index.md) / bindNodeCallback
...
function which returns the Observable that delivers the same values the Node.js callback would deliver.
...
Defined in: [internal/observable/bindNodeCallback.ts:6](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/bindNodeCallback.ts#L6)
...
```ts
function bindNodeCallback<>(callbackFunc: (...args: [...A[], (err: any, ...res: R) => void]) => void, schedulerLike?: SchedulerLike): (...arg: A) => Observable<R extends [] ? void : R extends [any] ? R<R>[0] : R>;
```

Defined in: [internal/observable/bindNodeCallback.ts:13](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/bindNodeCallback.ts#L13)
