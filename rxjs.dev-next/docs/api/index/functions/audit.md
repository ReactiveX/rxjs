[API](../../index.md) / [index](../index.md) / audit
...
Defined in: [internal/operators/audit.ts:53](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/audit.ts#L53)
