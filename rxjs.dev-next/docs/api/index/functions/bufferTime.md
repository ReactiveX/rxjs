[API](../../index.md) / [index](../index.md) / bufferTime
...
Defined in: [internal/operators/bufferTime.ts:10](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/bufferTime.ts#L10)
...
scheduler?: SchedulerLike): OperatorFunction<T, T[]>;
```

Defined in: [internal/operators/bufferTime.ts:11](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/bufferTime.ts#L11)
...
Defined in: [internal/operators/bufferTime.ts:16](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/bufferTime.ts#L16)
