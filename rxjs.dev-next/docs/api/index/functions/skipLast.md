[API](../../index.md) / [index](../index.md) / skipLast
...
Defined in: [internal/operators/skipLast.ts:48](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/skipLast.ts#L48)
