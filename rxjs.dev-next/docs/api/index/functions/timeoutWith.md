[API](../../index.md) / [index](../index.md) / timeoutWith
...
- You want to emit a custom error rather than the [TimeoutError](../interfaces/TimeoutError.md) emitted
...
scheduler?: SchedulerLike): OperatorFunction<T, T | R>;
```

Defined in: [internal/operators/timeoutWith.ts:8](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeoutWith.ts#L8)
...
Defined in: [internal/operators/timeoutWith.ts:11](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeoutWith.ts#L11)
