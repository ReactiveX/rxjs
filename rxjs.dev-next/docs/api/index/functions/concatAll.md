[API](../../index.md) / [index](../index.md) / concatAll
...
Defined in: [internal/operators/concatAll.ts:60](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/concatAll.ts#L60)
