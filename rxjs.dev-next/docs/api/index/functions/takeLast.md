[API](../../index.md) / [index](../index.md) / takeLast
...
Defined in: [internal/operators/takeLast.ts:45](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/takeLast.ts#L45)
