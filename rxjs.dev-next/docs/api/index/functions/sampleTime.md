[API](../../index.md) / [index](../index.md) / sampleTime
...
Defined in: [internal/operators/sampleTime.ts:49](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/sampleTime.ts#L49)
