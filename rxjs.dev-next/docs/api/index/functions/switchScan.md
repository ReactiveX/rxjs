[API](../../index.md) / [index](../index.md) / switchScan
...
Defined in: [internal/operators/switchScan.ts:24](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/switchScan.ts#L24)
