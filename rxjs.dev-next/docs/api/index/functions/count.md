[API](../../index.md) / [index](../index.md) / count
...
Defined in: [internal/operators/count.ts:59](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/count.ts#L59)
