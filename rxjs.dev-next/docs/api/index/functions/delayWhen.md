[API](../../index.md) / [index](../index.md) / delayWhen
...
Observable emits (guide/glossary-and-semantics#next nexts) any value.
Upon that, the "duration" Observable gets unsubscribed.

Before RxJS V7, the guide/glossary-and-semantics#complete completion
...
function that returns an Observable that delays the emissions of the source Observable by an amount of time specified by the Observable returned by .


## Call Signature

```ts
function delayWhen<>(delayDurationSelector: (value: T, index: number) => ObservableInput<any>, subscriptionDelay: Observable<any>): MonoTypeOperatorFunction<T>;
```

Defined in: [internal/operators/delayWhen.ts:11](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/delayWhen.ts#L11)
...
Defined in: [internal/operators/delayWhen.ts:15](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/delayWhen.ts#L15)
