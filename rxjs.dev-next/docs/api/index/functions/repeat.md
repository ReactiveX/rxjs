[API](../../index.md) / [index](../index.md) / repeat
...
Defined in: [internal/operators/repeat.ts:116](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/repeat.ts#L116)
