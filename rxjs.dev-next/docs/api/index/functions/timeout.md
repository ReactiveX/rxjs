[API](../../index.md) / [index](../index.md) / timeout
...
```ts
function timeout<>(config: TimeoutConfig<T, O, M> & {
  with: (info: TimeoutInfo<T, M>) => O;
}): OperatorFunction<T, T | ObservedValueOf<O>>;
```

Defined in: [internal/operators/timeout.ts:162](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeout.ts#L162)
...
when timeout conditions are met, this operator will emit a [TimeoutError](../variables/TimeoutError.md). Otherwise, it will use the factory
...
Defined in: [internal/operators/timeout.ts:256](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeout.ts#L256)
...
If no `with` property was provided, subscriptions to the resulting observable may emit an error of [TimeoutError](../variables/TimeoutError.md).
...
Emit a [TimeoutError](../variables/TimeoutError.md) if the first value, and _only_ the first value, does not arrive within 5 seconds
...
Emit a [TimeoutError](../variables/TimeoutError.md) if the source waits longer than 5 seconds between any two values or the first value
and subscription.
...
Emit a [TimeoutError](../variables/TimeoutError.md) if the source does not emit before 7 seconds, _or_ if the source waits longer than
...
Defined in: [internal/operators/timeout.ts:270](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeout.ts#L270)
...
Defined in: [internal/operators/timeout.ts:284](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/timeout.ts#L284)
