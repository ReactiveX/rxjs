[API](../../index.md) / [index](../index.md) / sample
...
Defined in: [internal/operators/sample.ts:47](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/sample.ts#L47)
