[API](../../index.md) / [index](../index.md) / distinctUntilChanged
...
Defined in: [internal/operators/distinctUntilChanged.ts:6](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/distinctUntilChanged.ts#L6)
...
```ts
function distinctUntilChanged<>(comparator: (previous: K, current: K) => boolean, keySelector: (value: T) => K): MonoTypeOperatorFunction<T>;
```

Defined in: [internal/operators/distinctUntilChanged.ts:7](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/distinctUntilChanged.ts#L7)
