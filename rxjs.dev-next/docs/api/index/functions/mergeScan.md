[API](../../index.md) / [index](../index.md) / mergeScan
...
Defined in: [internal/operators/mergeScan.ts:70](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/mergeScan.ts#L70)
