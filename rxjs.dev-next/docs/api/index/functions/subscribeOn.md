[API](../../index.md) / [index](../index.md) / subscribeOn
...
Defined in: [internal/operators/subscribeOn.ts:63](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/subscribeOn.ts#L63)
