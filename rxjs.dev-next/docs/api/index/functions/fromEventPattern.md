[API](../../index.md) / [index](../index.md) / fromEventPattern
...
```ts
function fromEventPattern<>(addHandler: (handler: NodeEventHandler) => any, removeHandler?: (handler: NodeEventHandler, signal?: any) => void): Observable<T>;
```

Defined in: [internal/observable/fromEventPattern.ts:7](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/fromEventPattern.ts#L7)
...
Defined in: [internal/observable/fromEventPattern.ts:11](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/fromEventPattern.ts#L11)
