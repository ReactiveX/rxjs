[API](../../index.md) / [index](../index.md) / interval
...
Defined in: [internal/observable/interval.ts:50](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/interval.ts#L50)
...
`async` [SchedulerLike](../interfaces/SchedulerLike.md) to provide a notion of time, but you may pass any
