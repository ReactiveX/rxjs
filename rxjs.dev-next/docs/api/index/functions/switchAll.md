[API](../../index.md) / [index](../index.md) / switchAll
...
Defined in: [internal/operators/switchAll.ts:63](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/switchAll.ts#L63)
