[API](../../index.md) / [index](../index.md) / Scheduler
...
Defined in: [internal/Scheduler.ts:24](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/Scheduler.ts#L24)
...
Defined in: [internal/Scheduler.ts:27](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/Scheduler.ts#L27)

#### Parameters

| Parameter | Type | Default value |
| ------ | ------ | ------ |
| `schedulerActionCtor` | *typeof* `Action` | `undefined` |
