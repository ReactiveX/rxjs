[API](../../index.md) / [index](../index.md) / ConnectableObservable
...
**deprecated**: Will be removed in v8. Use [connectable](../functions/connectable.md) to create a connectable observable.
If you are using the `refCount` method of `ConnectableObservable`, use the [share](../functions/share.md) operator
instead.
Details: https://rxjs.dev/deprecations/multicasting

Defined in: [internal/observable/ConnectableObservable.ts:16](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/ConnectableObservable.ts#L16)

ConnectableObservable<T>

## Deprecated

Will be removed in v8. Use [connectable](../functions/connectable.md) to create a connectable observable.
If you are using the `refCount` method of `ConnectableObservable`, use the [share](../functions/share.md) operator
instead.
Details: https://rxjs.dev/deprecations/multicasting
...
```ts
new ConnectableObservable<>(source: Observable<T>, subjectFactory: () => Subject<T>): ConnectableObservable<T>;
```

Defined in: [internal/observable/ConnectableObservable.ts:32](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/ConnectableObservable.ts#L32)

#### Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `source` | [`Observable`](Observable.md)\<`T`\> | The source observable |
| `subjectFactory` | () => [`Subject`](Subject.md)\<`T`\> | The factory that creates the subject used internally. |
...
When the `refCount()` method is needed, the [share](../functions/share.md) operator should be used instead:
...
| ------ | ------ | ------ | ------ |
| <a id="operator"></a> ~~`operator`~~ | [`Operator`](../interfaces/Operator.md)\<`any`, `T`\> \| `undefined` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | [`Observable`](Observable.md).[`operator`](Observable.md#operator) |
| <a id="source"></a> ~~`source`~~ | [`Observable`](Observable.md)\<`T`\> | The source observable | [`Observable`](Observable.md).[`source`](Observable.md#source) |
| <a id="create"></a> ~~`create`~~ | (...`args`: `any`[]) => `any` | Creates a new Observable by calling the Observable constructor **Deprecated** Use `new Observable()` instead. Will be removed in v8. | [`Observable`](Observable.md).[`create`](Observable.md#create) |
...
Defined in: [internal/observable/ConnectableObservable.ts:66](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/ConnectableObservable.ts#L66)
...
ConnectableObservable will be removed in v8. Use [connectable](../functions/connectable.md) instead.
Details: https://rxjs.dev/deprecations/multicasting
...
[`Observable`](Observable.md).[`forEach`](Observable.md#foreach)
...
[`Observable`](Observable.md).[`lift`](Observable.md#lift)
...
[`Observable`](Observable.md).[`pipe`](Observable.md#pipe)
...
Defined in: [internal/observable/ConnectableObservable.ts:101](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/observable/ConnectableObservable.ts#L101)
...
ConnectableObservable will be removed in v8. Use the [share](../functions/share.md) operator instead.
Details: https://rxjs.dev/deprecations/multicasting
...
[`Observable`](Observable.md).[`toPromise`](Observable.md#topromise)
