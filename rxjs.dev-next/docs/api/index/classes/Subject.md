[API](../../index.md) / [index](../index.md) / Subject
...
Defined in: [internal/Subject.ts:17](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/Subject.ts#L17)
...
```ts
new Subject<>(): Subject<T>;
```

Defined in: [internal/Subject.ts:40](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/Subject.ts#L40)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="closed"></a> `closed` | `boolean` | `false` | - | - | - |
| <a id="haserror"></a> ~~`hasError`~~ | `boolean` | `false` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | - |
| <a id="isstopped"></a> ~~`isStopped`~~ | `boolean` | `false` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | - |
| <a id="observers"></a> ~~`observers`~~ | [`Observer`](../interfaces/Observer.md)\<`T`\>[] | `[]` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | - |
| <a id="operator"></a> ~~`operator`~~ | [`Operator`](../interfaces/Operator.md)\<`any`, `T`\> \| `undefined` | `undefined` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | [`Observable`](Observable.md).[`operator`](Observable.md#operator) |
| <a id="source"></a> ~~`source`~~ | [`Observable`](Observable.md)\<`any`\> \| `undefined` | `undefined` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | [`Observable`](Observable.md).[`source`](Observable.md#source) |
| <a id="thrownerror"></a> ~~`thrownError`~~ | `any` | `null` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | - | - |
| <a id="create"></a> ~~`create`~~ | (...`args`: `any`[]) => `any` | `undefined` | Creates a "subject" by basically gluing an observer to an observable. **Deprecated** Recommended you do not use. Will be removed at some point in the future. Plans for replacement still under discussion. | [`Observable`](Observable.md).[`create`](Observable.md#create) | - |
...
Defined in: [internal/Subject.ts:59](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/Subject.ts#L59)
