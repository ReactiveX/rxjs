[API](../../index.md) / [index](../index.md) / RetryConfig
...
Defined in: [internal/operators/retry.ts:13](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/operators/retry.ts#L13)
