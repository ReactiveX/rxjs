[API](../../index.md) / [index](../index.md) / Connectable
...
Defined in: [internal/types.ts:363](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/types.ts#L363)
...
| ------ | ------ | ------ | ------ |
| <a id="operator"></a> ~~`operator`~~ | [`Operator`](Operator.md)\<`any`, `T`\> \| `undefined` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | [`Observable`](../classes/Observable.md).[`operator`](../classes/Observable.md#operator) |
| <a id="source"></a> ~~`source`~~ | [`Observable`](../classes/Observable.md)\<`any`\> \| `undefined` | **Deprecated** Internal implementation detail, do not use directly. Will be made internal in v8. | [`Observable`](../classes/Observable.md).[`source`](../classes/Observable.md#source) |
...
Defined in: [internal/types.ts:370](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/types.ts#L370)

(Idempotent) Calling this method will connect the underlying source observable to all subscribed consumers
through an underlying [Subject](../classes/Subject.md).
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `operator?` | [`Operator`](Operator.md)\<`T`, `R`\> | the operator defining the operation to take on the observable |
...
[`Observable`](../classes/Observable.md).[`lift`](../classes/Observable.md#lift)
...
| Parameter | Type |
| ------ | ------ |
| `op1` | [`OperatorFunction`](OperatorFunction.md)\<`T`, `A`\> |
...
| ------ | ------ |
| `op1` | [`OperatorFunction`](OperatorFunction.md)\<`T`, `A`\> |
| `op2` | [`OperatorFunction`](OperatorFunction.md)\<`A`, `B`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`B`\>
...
| `op1` | [`OperatorFunction`](OperatorFunction.md)\<`T`, `A`\> |
| `op2` | [`OperatorFunction`](OperatorFunction.md)\<`A`, `B`\> |
| `op3` | [`OperatorFunction`](OperatorFunction.md)\<`B`, `C`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`C`\>
...
| `op2` | [`OperatorFunction`](OperatorFunction.md)\<`A`, `B`\> |
| `op3` | [`OperatorFunction`](OperatorFunction.md)\<`B`, `C`\> |
| `op4` | [`OperatorFunction`](OperatorFunction.md)\<`C`, `D`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`D`\>
...
| `op3` | [`OperatorFunction`](OperatorFunction.md)\<`B`, `C`\> |
| `op4` | [`OperatorFunction`](OperatorFunction.md)\<`C`, `D`\> |
| `op5` | [`OperatorFunction`](OperatorFunction.md)\<`D`, `E`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`E`\>
...
| `op4` | [`OperatorFunction`](OperatorFunction.md)\<`C`, `D`\> |
| `op5` | [`OperatorFunction`](OperatorFunction.md)\<`D`, `E`\> |
| `op6` | [`OperatorFunction`](OperatorFunction.md)\<`E`, `F`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`F`\>
...
| `op5` | [`OperatorFunction`](OperatorFunction.md)\<`D`, `E`\> |
| `op6` | [`OperatorFunction`](OperatorFunction.md)\<`E`, `F`\> |
| `op7` | [`OperatorFunction`](OperatorFunction.md)\<`F`, `G`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`G`\>
...
| `op6` | [`OperatorFunction`](OperatorFunction.md)\<`E`, `F`\> |
| `op7` | [`OperatorFunction`](OperatorFunction.md)\<`F`, `G`\> |
| `op8` | [`OperatorFunction`](OperatorFunction.md)\<`G`, `H`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`H`\>
...
| `op7` | [`OperatorFunction`](OperatorFunction.md)\<`F`, `G`\> |
| `op8` | [`OperatorFunction`](OperatorFunction.md)\<`G`, `H`\> |
| `op9` | [`OperatorFunction`](OperatorFunction.md)\<`H`, `I`\> |

##### Returns

[`Observable`](../classes/Observable.md)\<`I`\>
...
| `op8` | [`OperatorFunction`](OperatorFunction.md)\<`G`, `H`\> |
| `op9` | [`OperatorFunction`](OperatorFunction.md)\<`H`, `I`\> |
| ...`operations` | [`OperatorFunction`](OperatorFunction.md)\<`any`, `any`\>[] |
...
Either an [Observer](Observer.md) with some or all callback methods,
...
| Parameter | Type |
| ------ | ------ |
| `observerOrNext?` | `Partial`\<[`Observer`](Observer.md)\<`T`\>\> \| (`value`: `T`) => `void` |
...
[`Observable`](../classes/Observable.md).[`toPromise`](../classes/Observable.md#topromise)
