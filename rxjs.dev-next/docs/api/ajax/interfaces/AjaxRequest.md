...
This is provided in [AjaxError](AjaxError.md) instances as the `request`
object.

Defined in: [internal/ajax/types.ts:20](https://github.com/JessicaSachs/rxjs/blob/master/src/internal/ajax/types.ts#L20)
