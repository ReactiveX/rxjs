[API](../../index.md) / [operators](../index.md) / mergeMap
...
these inner Observables using [mergeAll](../../index/functions/mergeAll.md).</span>
...
## See
 ...
 - [concatMap](../../index/functions/concatMap.md)
 - [exhaustMap](../../index/functions/exhaustMap.md)
 - [merge](merge.md)
 - [mergeAll](../../index/functions/mergeAll.md)
 - [mergeMapTo](../../index/functions/mergeMapTo.md)
 - [mergeScan](../../index/functions/mergeScan.md)
...
[`OperatorFunction`](../../index/interfaces/OperatorFunction.md)\<`T`, [`ObservedValueOf`](../../index/type-aliases/ObservedValueOf.md)\<`O`\>\>
...
| ------ | ------ |
| `project` | (`value`: `T`, `index`: `number`) => `O` |
| `resultSelector` | (`outerValue`: `T`, `innerValue`: [`ObservedValueOf`](../../index/type-aliases/ObservedValueOf.md)\<`O`\>, `outerIndex`: `number`, `innerIndex`: `number`) => `R` |
| `concurrent?` | `number` |
