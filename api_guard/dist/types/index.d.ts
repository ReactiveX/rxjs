...
export declare function combineLatest<A extends readonly unknown[], R>(sources: readonly [...ObservableInputTuple<A>], scheduler: SchedulerLike): Observable<R>;
export declare function combineLatest<A extends readonly unknown[], R>(sources: readonly [...ObservableInputTuple<A>], resultSelector: (...args: A) => R, scheduler?: SchedulerLike): Observable<R>;
export declare function combineLatest<A extends readonly unknown[]>(sources: readonly [...ObservableInputTuple<A>]): Observable<A>;
export declare function combineLatest<T, R>(source: ObservableInput<T>, resultSelector: (value: T) => R, scheduler?: SchedulerLike): Observable<R>;
export declare function combineLatest<T>(source: ObservableInput<T>, scheduler: SchedulerLike): Observable<[T]>;
export declare function combineLatest<T>(source: ObservableInput<T>): Observable<[T]>;
export declare function combineLatest<A extends readonly unknown[], R>(...sources: [...ObservableInputTuple<A>, (...args: A) => R]): Observable<R>;
export declare function combineLatest<A extends readonly unknown[], R>(...sources: [...ObservableInputTuple<A>, (...args: A) => R, SchedulerLike]): Observable<R>;
export declare function combineLatest<A extends readonly unknown[]>(...sources: [...ObservableInputTuple<A>, SchedulerLike]): Observable<A>;
