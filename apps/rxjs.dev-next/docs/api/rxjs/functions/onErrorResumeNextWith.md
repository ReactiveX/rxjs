[API](../../index.md) / [rxjs](../index.md) / onErrorResumeNextWith
...
`onErrorResumeNext` can be therefore thought of as version of [concatWith](concatWith.md) operator, which is more permissive
...
Defined in: [rxjs/src/internal/operators/onErrorResumeNextWith.ts:5](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/onErrorResumeNextWith.ts#L5)
...
Defined in: [rxjs/src/internal/operators/onErrorResumeNextWith.ts:8](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/onErrorResumeNextWith.ts#L8)
