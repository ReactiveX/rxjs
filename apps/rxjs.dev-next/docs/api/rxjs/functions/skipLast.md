[API](../../index.md) / [rxjs](../index.md) / skipLast

# Function: skipLast()

```ts
function skipLast<>(skipCount: number): MonoTypeOperatorFunction<T>;
```

Defined in: [rxjs/src/internal/operators/skipLast.ts:47](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/skipLast.ts#L47)
