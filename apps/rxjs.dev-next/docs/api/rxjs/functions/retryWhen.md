[API](../../index.md) / [rxjs](../index.md) / retryWhen
...
Defined in: [rxjs/src/internal/operators/retryWhen.ts:62](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/retryWhen.ts#L62)
