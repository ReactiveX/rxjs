[API](../../index.md) / [rxjs](../index.md) / bufferCount
...
Defined in: [rxjs/src/internal/operators/bufferCount.ts:56](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/bufferCount.ts#L56)
