[API](../../index.md) / [rxjs](../index.md) / repeatWhen
...
Defined in: [rxjs/src/internal/operators/repeatWhen.ts:40](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/repeatWhen.ts#L40)
