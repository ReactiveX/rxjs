[API](../../index.md) / [rxjs](../index.md) / windowToggle
...
Defined in: [rxjs/src/internal/operators/windowToggle.ts:52](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/windowToggle.ts#L52)
