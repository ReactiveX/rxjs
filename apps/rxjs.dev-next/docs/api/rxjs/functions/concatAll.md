[API](../../index.md) / [rxjs](../index.md) / concatAll

# Function: concatAll()

```ts
function concatAll<>(): OperatorFunction<O, ObservedValueOf<O>>;
```

Defined in: [rxjs/src/internal/operators/concatAll.ts:60](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/concatAll.ts#L60)
...
<div><img class="only-light" src="/images/marble-diagrams/concatAll-light.svg" alt="Marble diagram" />
<img class="only-dark" src="/images/marble-diagrams/concatAll-dark.svg" alt="Marble diagram" /></div>
