[API](../../index.md) / [rxjs](../index.md) / skip
...
Defined in: [rxjs/src/internal/operators/skip.ts:37](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/skip.ts#L37)
