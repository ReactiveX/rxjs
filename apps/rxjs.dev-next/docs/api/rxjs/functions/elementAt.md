[API](../../index.md) / [rxjs](../index.md) / elementAt
...
Defined in: [rxjs/src/internal/operators/elementAt.ts:54](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/elementAt.ts#L54)
