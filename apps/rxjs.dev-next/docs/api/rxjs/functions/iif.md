[API](../../index.md) / [rxjs](../index.md) / iif

# Function: iif()

```ts
function iif<>(condition: () => boolean, trueResult: ObservableInput<T>, falseResult: ObservableInput<F>): Observable<T | F>;
```

Defined in: [rxjs/src/internal/observable/iif.ts:83](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/observable/iif.ts#L83)
...
let accessGranted;
const observableIfYouHaveAccess = iif(() => accessGranted, of('It seems you have an access...'), EMPTY);
