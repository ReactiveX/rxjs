[API](../../index.md) / [rxjs](../index.md) / using

# Function: using()

```ts
function using<>(
  resourceFactory: () => void | Unsubscribable,
  observableFactory: (resource: void | Unsubscribable) => void | T
): Observable<ObservedValueOf<T>>;
```

Defined in: [rxjs/src/internal/observable/using.ts:31](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/observable/using.ts#L31)
