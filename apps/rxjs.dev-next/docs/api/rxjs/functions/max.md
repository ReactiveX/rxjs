[API](../../index.md) / [rxjs](../index.md) / max
...
Defined in: [rxjs/src/internal/operators/max.ts:52](https://github.com/ReactiveX/rxjs/blob/master/packages/rxjs/src/internal/operators/max.ts#L52)
