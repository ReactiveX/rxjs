[API](../../index.md) / [rxjs](../index.md) / Observable
...
Defined in: [observable/src/observable.ts:632](https://github.com/ReactiveX/rxjs/blob/master/packages/observable/src/observable.ts#L632)
...
- [`Subject`](Subject.md)
- [`WebSocketSubject`](../../webSocket/classes/WebSocketSubject.md)
...
Defined in: [observable/src/observable.ts:639](https://github.com/ReactiveX/rxjs/blob/master/packages/observable/src/observable.ts#L639)
