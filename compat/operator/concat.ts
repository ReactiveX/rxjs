import { concat as concatStatic, Observable, ObservableInput, SchedulerLike } from 'rxjs';
 ...
 * @return {Observable} All values of each passed Observable smooshed into a
